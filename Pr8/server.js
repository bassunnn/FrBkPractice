...
const swaggerOptions = {
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description: 'Практическое занятие №8: JWT‑аутентификация и CRUD для товаров',
        },
        servers: [
            {
...
function authMiddleware(req, res, next) {
    ...
    try {
        ...
        req.user = payload;   // сохраняем данные токена (sub, email, iat, exp)
        next();
    } catch (err) {
 ...
 *               $ref: '#/components/schemas/Error'
 *       404:
 *         description: Пользователь не найден (например, был удалён)
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Error'
